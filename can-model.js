...
function addLights() {
    ...
    const mainLight = new THREE.DirectionalLight(0xe65b07, 1.5); // Orange-red color
    mainLight.position.set(5, 5, 5);
    scene.add(mainLight);

    // Fill light (opposite of main light)
    const fillLight = new THREE.DirectionalLight(0xb34605, 0.8); // Darker orange-red
...
function updateSceneForTheme(isLightTheme) {
    ...
    // Update lighting intensity based on theme
